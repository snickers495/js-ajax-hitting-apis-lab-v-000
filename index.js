...
function showRepositories(event, data) {
  ...
  console.log(repos)
  const repoList = `<ul>${repos.map(r => '<li>' + r.name + ' - <a href="#" data-repo="' + r.name + '" onclick="getCommits(this)">Get Commits</a></li>' + ' - '+'<a href="#" data-repo="' + r.name + '" onclick="getBranches(this)">Get Branches</a>').join('')}</ul>`
